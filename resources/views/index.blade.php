                    ...
                    <div class="mx-10 md:mx-16">
                        ...
                        <div class="bg-newGreen flex flex-col md:flex-row p-8 md:p-6 gap-6 rounded-xl mb-6 shadow-lg">
                            ...
                            <div class="w-full md:w-4/12">
                                <img src="{{ asset('storage/' . $car->image) }}" alt="Fortuner" class="rounded-xl">
                            </div>
                            {{-- deskripsi singkat --}}
                            <div class="w-full md:w-8/12">
                                ...
                                <div class="mt-4">
                                    <a href="{{ route('car-detail', ['id' => $car->id]) }}" class="border-2 border-newGold bg-newGold text-black py-2 px-4 rounded-lg hover:bg-newGreen hover:text-newGold  transition">Selengkapnya</a>
                                </div>
        ...
        <div class="mx-6 md:mx-12 lg:mx-16 my-8">
            ...
            <div class="bg-newGreen p-5 md:p-10">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div><img src="{{ asset('storage/' . $gallery->image) }}" alt="" class="w-[27rem] h-[19rem] object-cover transition-transform transform hover:scale-105 hover:shadow-lg"></div>
                    @endforeach
