                ...
                <div>
                    ...
                    <div class="mx-10 md:mx-16">
                        ...
                        <div class="bg-newGreen flex flex-col md:flex-col lg:flex-row p-8 md:p-6 gap-6 rounded-xl mb-6 shadow-lg ">
                            {{-- Gambar mobil --}}
                            <div class="">
                                <img src="{{ asset('storage/' . $car->image) }}" alt="{{ $car->car_name }}" class="rounded-xl w-full lg:w-[29rem] lg:h-[14rem]  object-cover">
                            </div>
                            ...
                            <div class="text-[#E0E0E0] w-full md:w-full lg:w-8/12 flex flex-col justify-between">
                                ...
                                <div class="flex flex-col md:flex-row justify-between lg:mt-0 mt-8 space-y-4">
                                    <div class="mb-4 md:mb-0">
                                        <a href="{{ route('car-detail', ['id' => $car->id]) }}" class="font-[poppins] border-2 border-newGold bg-newGold text-hitam py-2 px-4 rounded-lg hover:bg-newGreen hover:text-newGold transition">
                                            Selengkapnya
                                        </a>
                                    </div>
                                    <div class="md:text-right text-lg md:text-xl font-bold">
                                        Rp {{ number_format($car->price, 0, ',', '.') }} <span class="text-newGold">/ </span> Hari
                                    </div>
                                </div>
                            </div>
                        </div>
